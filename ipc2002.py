...
#打开指定的文件 
datafile = r'E:\plot\pyxls\IPC3-hpZ230.xlsx'
...
# sheetdomainname = 'DriverLog'
print(sheetdomainname)
...
#绘制图形
ax1 = plt.subplot(231)
ax1.set_title(sheetdomainname, fontsize=9)
...
#绘制图形
ax2 = plt.subplot(232)
ax2.set_title(sheetdomainname, fontsize=9)
...
#绘制图形
ax3 = plt.subplot(233)
ax3.set_title(sheetdomainname, fontsize=9)
...
#绘制图形
ax4 = plt.subplot(234)
ax4.set_title(sheetdomainname, fontsize=9)
...
foo_fig.savefig(r'E:\plot\pyxls\IPC3.png', dpi=600)
