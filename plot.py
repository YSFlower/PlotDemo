...
# 打开指定的文件
datafile = r'F:\pyxls\IPC4-hpZ230.xlsx'
...
rowsrange
print
sheet.cell(0, fftimecolx).ctype  # ctype: 2-number
print
len(ffcols), ffcols
print
len(asopcols), asopcols

# 绘制图形
ax1 = plt.subplot(231)
ax1.set_title(sheetdomainname,fontsize=10)
# ax1.set_xlabel('Tasks')
# ax1.set_ylabel('Running Time (s)')

plt.plot(rowsrange, ffcols[0: Nrows],marker='o', markersize=3, linestyle='-.', linewidth=1, label='FF')
plt.plot(rowsrange, asopcols[0: Nrows],marker='s', markersize=3, linestyle=':', linewidth=1, label='AOIP')
plt.semilogy(0.1, 1000)
# plt.xlim(1,55)
# plt.axis([0,55,0,1000])
plt.xscale('linear')
plt.yscale('log')
# plt.xticks(range(0,55,10))
# plt.yticks(range(1,1000,10))
...
foo_fig.savefig(r'F:\pyxls\foo.png', dpi=300)
